        ...
        <div className="container">
          ...
          <div className="row d-flex justify-content-between">
            <div className="col-xs-1 col-sm-3 img-boxes p-0" id="img-box1">
              ...
              <img className="img-fluid img-hero" src="./assets/images/local.jpg" />
            ...
            <div className="col-xs-1 col-sm-3 img-boxes p-0" id="img-box2">
              ...
              <img className="img-fluid img-hero" src="./assets/images/global.jpg" />
            </div>
            <div className="col-xs-1 col-sm-3 img-boxes p-0" id="img-box3">
              ...
              <img className="img-fluid img-hero" src="./assets/images/cleanup.jpg" />
            </div>
          </div>
        </div>
